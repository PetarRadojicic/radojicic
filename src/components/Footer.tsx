...
export function Footer() {
  ...
  return (
    <footer className="w-full py-20 px-6 snap-start snap-always flex items-center justify-center min-h-screen">
      ...
      >
        <motion.div 
          className="bg-white/10 backdrop-blur-[20px] rounded-3xl border border-white/20 p-8 md:p-12 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] hover:bg-white/15 hover:border-white/30 transition-all duration-500"
        ...
        >
          ...
          <motion.div 
            className="border-t-2 border-white/20 mt-12 pt-8"
            variants={itemVariants}
          >
