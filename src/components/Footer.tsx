              ...
              <div className="space-y-4">
                <div className="flex items-center justify-center space-x-3">
                  ...
                  <a 
                    ...
                    className="text-white/80 hover:text-white transition-colors drop-shadow-[0_1px_10px_rgba(0, 0, 0,0.2)] text-shadow-[1px_1px_2px_rgba(0,0,0,0.4)]"
                  >
                    petar@radojicic.co
                  </a>
                </div>
                <div className="flex items-center justify-center space-x-3">
                  ...
                  <span className="text-white/80 drop-shadow-[0_1px_10px_rgba(0, 0, 0,0.2)] text-shadow-[1px_1px_2px_rgba(0,0,0,0.4)]">
                    {t('footer.location')}
                  </span>
                </div>
              </div>
            ...
            <div className="space-y-6 text-center">
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                >
                  ...
                  <span className="font-medium text-shadow-[1px_1px_2px_rgba(0,0,0,0.4)]">LinkedIn</span>
                </a>
              </div>
            </div>
            ...
            <div className="space-y-6 text-center">
              ...
              <div className="flex flex-col items-center space-y-3">
                <button 
                  ...
                  className="text-white/80 hover:text-white transition-colors cursor-pointer drop-shadow-[0_1px_10px_rgba(0, 0, 0,0.2)] font-medium text-shadow-[1px_1px_2px_rgba(0,0,0,0.4)]"
                >
                  {t('footer.aboutMe')}
                </button>
                <button 
